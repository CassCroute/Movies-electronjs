...
var handleSquirrelEvent = function () {
    ...
    function executeSquirrelCommand(args, done) {
        var updateDotExe = path_1.default.resolve(path_1.default.dirname(process.execPath), '..', 'update.exe');
        var child = child_process_1.default.spawn(updateDotExe, args, { detached: true });
    ...
    function install(done) {
        var target = path_1.default.basename(process.execPath);
